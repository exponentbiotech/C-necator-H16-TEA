#!/usr/bin/env python3
"""
Leatherback Fairfield TEA Dashboard — v9
========================================
...
Run locally:
    cd ~/Downloads
    streamlit run tea_dashboard_v9.py
...
def _fairfield_single_result(
    ...
    total_revenue = annual_pha_kg * pha_revenue_price + annual_scp_kg * scp_target_price
...
st.title("Leatherback Fairfield TEA Dashboard v9")
st.caption(
    ...
    with c2:
        ...
        st.markdown(
            (
                ...
                f"<div><strong>Scenario 3:</strong> Narrative upside only, not modeled in v9</div>"
                f"</div>"
            ),
            unsafe_allow_html=True,
        )
